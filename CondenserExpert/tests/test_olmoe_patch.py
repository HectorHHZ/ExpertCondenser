...
from CondenserExpert.utils import olmoe_patch


def test_select_forced_experts_tracks_lowest_bias():
    olmoe_patch.FORCED_EXPERTS_RECORDS.clear()

    block = olmoe_patch.AuxFreeOlmoeSparseMoeBlock.__new__(olmoe_patch.AuxFreeOlmoeSparseMoeBlock)
    ...
    record = olmoe_patch.FORCED_EXPERTS_RECORDS["layer0"]
